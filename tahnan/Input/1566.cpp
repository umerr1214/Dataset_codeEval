...
public:
    ...
    void configure(int x){ cout<<"Configuring Router"<<endl; } // Semantic error: wrong function signature
};
...
int main() {
    ...
    r.configure(); // Semantic error: calls base function because signature mismatch
    s.configure();
    return 0;
}

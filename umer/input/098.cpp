...
public:
    ...
    // Remove quotation - logical error: wrong indexing
    void removeQuotation(char* keyword) {
        ...
        if (choice >= 1 && choice <= count) {
            // Logical error: using choice directly instead of indices[choice-1]
            int indexToDelete = choice - 1;  // Should be indices[choice - 1]

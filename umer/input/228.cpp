...
int main() {
    // Initialize test variables with meaningful values
    ...
    cout << "1. x is even and y is odd: " << expr1 << endl;
    cout << "3. x is not between -47.5 and 132.0: " << expr3 << endl;
    cout << "4. w > 200 and (x < 98.6 OR y < 60.0 OR z > 160.0): " << expr4 << endl;
    cout << "5. score is between 50 and 60 inclusive: " << expr5 << endl;
    cout << "6. age is outside the range p to q: " << expr6 << endl;
    cout << "7. at least one of x and y is odd: " << expr7 << endl;
    cout << "8. hit is not more than 6.7 units from target: " << expr8 << endl;
    cout << "9. ch is uppercase alphabetic: " << expr9 << endl;
    cout << "10. year is divisible by 4: " << expr10 << endl;
    cout << "11. w equals 6 or is not greater than 3: " << expr11 << endl;

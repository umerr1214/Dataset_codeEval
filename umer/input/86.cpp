...
public:
    ...
    // reSize - logical error: wrong condition for copying elements
    void reSize(int newCapacity) {
        ...
        int minSize = (capacity > newCapacity) ? capacity : newCapacity;  // Logical error: should be min, not max
        
        for (int i = 0; i < minSize; i++) {
            newData[i] = data[i];  // This will cause buffer overflow when capacity > newCapacity
        }

...
public:
    ...
    Student(string r, int a, float c) {  // Poor readability: should use const string& for efficiency
        rollNumber = r;
        age = a;
        cgpa = c;
    ...
    void setRollNumber(string r) {  // Should be const string& r
        rollNumber = r;
    }
    ...
    string getRollNumber() {  // Should return const string&
        return rollNumber;
    }
...
int main() {
    ...
    // Inefficient: multiple function calls instead of using print()
